...
export const DATASET_ACCESS_POLICIES: Record<string, DatasetPolicy> = {
  ...
  "corporate-actions": { datasetSlug: "corporate-actions", backendPath: "/v2/datasets/corporate-actions", requiredPlan: "pro", creditsCost: 1 },
  ...
  "interest-rate-snapshot": { datasetSlug: "interest-rate-snapshot", backendPath: "/v2/datasets/interest-rate-snapshot", requiredPlan: "pro", creditsCost: 1 },
  ...
  "tax-business-registration": { datasetSlug: "tax-business-registration", backendPath: "/v2/datasets/tax-business-registration", requiredPlan: "pro", creditsCost: 1 },
  ...
  "convertible-bond-monthly": { datasetSlug: "convertible-bond-monthly", backendPath: "/v2/datasets/convertible-bond-monthly", requiredPlan: "pro", creditsCost: 2 },
  ...
  "monthly-revenue-enhanced": { datasetSlug: "monthly-revenue-enhanced", backendPath: "/v2/datasets/monthly-revenue-enhanced", requiredPlan: "pro", creditsCost: 3 },
  ...
  "securities-lending": { datasetSlug: "securities-lending", backendPath: "/v2/datasets/chip-deep-securities-lending-daily", requiredPlan: "starter", creditsCost: 2 },
  "total-margin-short": { datasetSlug: "total-margin-short", backendPath: "/v2/datasets/total-margin-short", requiredPlan: "starter", creditsCost: 2 },
  ...
  "options-daily-taifex": { datasetSlug: "options-daily-taifex", backendPath: "/v2/datasets/options-daily-taifex", requiredPlan: "max", creditsCost: 3 },
