...
export type ApiStatusExample = {
  status: "200" | "400" | "401" | "402" | "403" | "404" | "429" | "503";
  description: string;
  body: string;
};
...
function buildApiStatusExamples(item: ApiPlaceholderItem): ApiStatusExample[] {
  ...
  return [
      ...
      body: JSON.stringify(
        {
          ...
          message: "缺少有效的 X-API-Key。（免 key 五檔 2330/2317/2454/0050/2603 除外，直接回 200）",
        },
        null,
        2,
      ),
    ...
    {
      status: "402",
      description: "方案未包含此資料集（付費牆）。",
      body: JSON.stringify(
        {
          error: "not_entitled_for_dataset",
          message: "目前方案未包含此資料集，升級方案即可存取。",
        },
        null,
        2,
      ),
...
const baseDocsPages: DocsPageEntry[] = [
  ...
  "data": [
    {
      ...
      "revision_at": "2026-01-10T09:20:00+08:00"
          ...
          { status: "400", description: "缺少必要參數 symbol", body: `{"error":"invalid_request","message":"symbol is required"}` },
          { status: "401", description: "API key 無效或缺失", body: `{"error":"unauthorized","message":"invalid api key"}` },
          { status: "404", description: "此主題尚未開通", body: `{"error":"not_found","message":"dataset not available in current rollout"}` },
        ],
      },
    },
  },
  ...
  "count": 1
          ...
          { status: "400", description: "ticker 與 query 皆未提供", body: `{"error":"invalid_request","message":"ticker or query is required"}` },
          { status: "401", description: "認證失敗", body: `{"error":"unauthorized","message":"invalid api key"}` },
          { status: "404", description: "查無公司資料", body: `{"error":"not_found","message":"company profile not found"}` },
        ],
      },
    },
  },
  ...
  "data": [
    {
      ...
      "eps_surprise_pct": 2.8
          ...
          { status: "400", description: "參數格式錯誤", body: `{"error":"invalid_request","message":"period format is invalid"}` },
          { status: "401", description: "認證失敗", body: `{"error":"unauthorized","message":"invalid api key"}` },
          { status: "404", description: "查無對應財報", body: `{"error":"not_found","message":"earnings data not found"}` },
        ],
      },
    },
  },
  ...
  "data": [
    {
      ...
      "market_cap": 21965000000000
          ...
          { status: "400", description: "參數錯誤", body: `{"error":"invalid_request","message":"symbol is required"}` },
          { status: "401", description: "認證失敗", body: `{"error":"unauthorized","message":"invalid api key"}` },
          { status: "404", description: "查無資料", body: `{"error":"not_found","message":"financial metrics not found"}` },
        ],
      },
    },
  },
  ...
  "data": [
    {
      ...
      "score": 0.98
          ...
          { status: "400", description: "缺少 query", body: `{"error":"invalid_request","message":"query is required"}` },
          { status: "401", description: "認證失敗", body: `{"error":"unauthorized","message":"invalid api key"}` },
          { status: "404", description: "查無結果", body: `{"error":"not_found","message":"no search result"}` },
        ],
      },
    },
  },
...
console.log(data)`,
  ...
  return {
    ...
    notes: [
      ...
      "idempotency 結論來自既有 artifacts + DB state，未執行 live source 重算。",
...
console.log(data)`,
  ...
  return {
    ...
    notes: [
      ...
      "來源與主表：mops_official，source-of-truth table 為 `fundamental_income_statements`。",
      "覆蓋統計：duplicate logical keys=0；實際覆蓋筆數與涵蓋股票數詳見 /datasets。",
      "資料治理：raw_payload 非空筆數=0（不保留 raw payload）。",
      "冪等性證據：would_insert=0、would_update=0（high confidence）。",
...
console.log(data)`,
  ...
  return {
    ...
    overview: [
      ...
      "凍結覆蓋區間為 2023Q2..2026Q1；此頁不代表完整歷史現金流覆蓋，也不是即時資料。",
    ],
    requestDescription: ["使用此 endpoint 時，建議："],
    useCases: [
      "檢查營運現金流與自由現金流的變化趨勢。",
    ...
    notes: [
      "Coverage（Phase A conservative baseline）：涵蓋 2023Q2..2026Q1 各季；實際覆蓋筆數詳見 /datasets。",
...
console.log(data)`,
  ...
  return {
    ...
    notes: [
      ...
      "來源與主表：mops_official 與 official_mopsov_ajax_t163sb05，source-of-truth table 為 `fundamental_balance_sheets`。",
      "覆蓋統計：duplicate logical keys=0；實際覆蓋筆數與涵蓋股票數詳見 /datasets。",
      "資料治理：raw_payload 非空筆數=0（不保留 raw payload）。",
      "冪等性證據：would_insert=0、would_update=0（high confidence）。",
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "statement_type 或 period_type 不支援", body: `{"error":"unsupported_statement_type"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取此資料", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "查詢參數錯誤", body: `{"error":"bad_request"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取此資料", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "adjustment_basis 不支援", body: `{"error":"unsupported_adjustment_basis"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取此資料", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "參數錯誤或缺少必要 filter", body: `{"error":"missing_required_filter"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取此資料", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "缺少必要參數或 index_id / market 不合法", body: `{"error":"invalid_request"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "查詢參數錯誤", body: `{"error":"invalid_query_params"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取此資料", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "缺少必要 filter 或排序參數錯誤", body: `{"error":"missing_required_filter"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取此資料", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
      ],
    },
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "type 不支援或參數非法（含部分驗證錯誤）", body: `{"error":"unsupported_search_type"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取搜尋能力", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
      ],
    },
  };
}
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "缺少 entity/fields、entity_type 不支援，或超過 batch 限制", body: `{"error":"missing_fields","message":"Provide fields or fields[]"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取此能力", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
      ],
    },
  };
}
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "entity_type 不支援（含部分驗證錯誤）", body: `{"error":"unsupported_entity_type"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取此能力", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
      ],
    },
  ...
  return {
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "查詢參數未 bounded、limit 超出範圍或缺少必要條件。", body: `{"error":"validation_error","error_code":"unbounded_query_or_invalid_params"}` },
        { status: "401", description: "缺少 API key 或驗證失敗。", body: `{"error":"missing_or_invalid_api_key"}` },
        { status: "402", description: "方案未授權或 dataset entitlement 不符合。", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
        { status: "429", description: "超過 rate limit。", body: `{"error":"rate_limited"}` },
        { status: "503", description: "route disabled 或 emergency disabled。", body: `{"error":"route_disabled","meta":{"production_ready":false}}` },
      ],
    },
  };
}
...
console.log(data)`,
  ...
  return {
    ...
    notes: [
      "目前 coverage 為 2026-03-10..2026-05-28；實際覆蓋筆數與涵蓋股票數詳見 /datasets。",
    ...
    sidePanel: {
      ...
      statusExamples: [
        ...
        { status: "400", description: "查詢參數錯誤", body: `{"error":"bad_request"}` },
        { status: "401", description: "缺少或無效 API key", body: `{"error":"missing_api_key"}` },
        { status: "402", description: "目前方案無法存取此 private beta 資料", body: `{"error":"not_entitled_for_dataset","message":"目前方案未包含此資料集，升級方案即可存取。"}` },
