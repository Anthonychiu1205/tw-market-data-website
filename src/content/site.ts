...
export const datasetProducts: DatasetProduct[] = [
  ...
  { id: "securities-lending", name: "securities-lending", domain: "籌碼與資金", marketCoverage: "TWSE 借券資料", maturity: "v2", readiness: "available_now", sourceOrigin: "TWSE official TWT72U", shortUseCase: "TWSE 借券餘額、借入、還券與 known gaps", endpoint: "/v2/datasets/securities-lending" },
