...
export const datasetProducts: DatasetProduct[] = [
  ...
  { id: "margin-short", name: "margin-short", domain: "籌碼與資金", marketCoverage: "融資融券", maturity: "v2", readiness: "available_now", sourceOrigin: "TWSE / TPEx", shortUseCase: "融資融券餘額與變化", endpoint: "/v2/datasets/margin-short" },
