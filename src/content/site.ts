...
export const datasetProducts: DatasetProduct[] = [
  ...
  { id: "market-breadth", name: "market-breadth", domain: "市場與價格", marketCoverage: "市場廣度（Private Beta）", maturity: "v2", readiness: "available_now", sourceOrigin: "TWSE-only", shortUseCase: "TWSE 漲跌家數、漲跌停與市場廣度欄位；Private Beta + source_lineage/data_gaps", endpoint: "/v2/datasets/market-breadth" },
