...
const panelClass = "rounded-2xl border border-slate-200 bg-white p-6";
  ...
  return (
    <div className="space-y-5 pb-8">
      <section className={panelClass}>
        <div className="flex flex-col gap-4 border-b border-slate-200 pb-5 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="text-2xl font-semibold tracking-tight text-slate-900">AI Research</h1>
              <span className="rounded-full border border-slate-300 bg-slate-50 px-2.5 py-1 text-[11px] font-medium text-slate-700">
                Pro+ feature
              </span>
              <span className="rounded-full border border-slate-300 bg-slate-50 px-2.5 py-1 text-[11px] font-medium text-slate-700">
                Simulation only
        ...
        <div className="grid gap-4 py-5 md:grid-cols-5">
          <div>
        ...
        <div className="border-t border-slate-200 pt-4">
          <p className="text-xs text-slate-500">Replay fingerprint</p>
          <p className="mt-1 font-mono text-sm text-slate-800">rf_2330_20260513_mock</p>
        </div>
      </section>
      ...
      <section className={panelClass}>
        ...
        <div className="mt-4 grid gap-5 lg:grid-cols-2">
          <div className="h-[260px] border border-slate-200 bg-slate-50/40 p-3">
            <p className="mb-2 text-xs text-slate-500">Confidence by analyst</p>
          ...
          <div className="h-[260px] border border-slate-200 bg-slate-50/40 p-3">
            <p className="mb-2 text-xs text-slate-500">Research coverage</p>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-slate-500">
              This is a simulated research output. No broker order is created.
            </p>
          </div>
        </div>
      </section>
