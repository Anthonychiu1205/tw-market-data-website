...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: Array<{ path: string; changeFrequency: ChangeFrequency; priority: number }> = [
    ...
    { path: "/datasets/tpex-daily-price", changeFrequency: "weekly", priority: 0.85 },
    { path: "/datasets/technical-indicators", changeFrequency: "weekly", priority: 0.85 },
    ...
    { path: "/datasets/valuation-data", changeFrequency: "weekly", priority: 0.85 },
    { path: "/datasets/issuer-profile", changeFrequency: "weekly", priority: 0.85 },
    { path: "/datasets/margin-short", changeFrequency: "weekly", priority: 0.85 },
    { path: "/datasets/company-events", changeFrequency: "weekly", priority: 0.85 },
