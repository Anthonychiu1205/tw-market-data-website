  ...
  },
  {
    ...
    datasets: [
      ...
      },
      {
        ...
        note: "此資料集 coverage 會依資料 rollout 與來源政策持續標示，請以 data_gaps 與 freshness 為準。",
      },
    ],
  },
  {
    ...
    datasets: [
      {
        ...
        overviewHref: "/datasets/company-events",
        note: "此資料集以 metadata-first 為主，不代表完整新聞全文資料庫。",
      },
    ],
  },
] as const;
...
export default function DatasetsPage() {
  const datasetItemListLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "TPEx 日線價格", url: "https://twmarketdata.com/datasets/tpex-daily-price" },
      { "@type": "ListItem", position: 3, name: "技術指標", url: "https://twmarketdata.com/datasets/technical-indicators" },
      ...
      { "@type": "ListItem", position: 10, name: "估值資料", url: "https://twmarketdata.com/datasets/valuation-data" },
      { "@type": "ListItem", position: 11, name: "公司基本資料", url: "https://twmarketdata.com/datasets/issuer-profile" },
      { "@type": "ListItem", position: 12, name: "公司事件與公告", url: "https://twmarketdata.com/datasets/company-events" },
    ],
  };
