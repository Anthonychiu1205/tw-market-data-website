  ...
  return (
    <Container className="space-y-10 py-12">
      <section className="space-y-3 border-b border-slate-200 pb-8">
        ...
        <p className="max-w-3xl text-base text-slate-600">目前 pricing / website public boundary 以 8 個 sellable-now dataset 為準；其餘資料能力仍維持 invited / preview 或後續擴充，billing 也仍保留 preview semantics。</p>
      </section>
      <PricingShell />
    </Container>
  );
